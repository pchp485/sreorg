      ...
      <div className="grid">
        ...
        <div className="card" style={{ borderColor: "var(--accent)" }}>
          ...
          <p style={{ fontSize: "1.6rem", margin: "0 0 12px" }}>
            {formatINR(MONTHLY.amountPaise)}<span style={{ fontSize: "1rem", color: "var(--muted)" }}>/month</span>
          </p>
          <ul>
          ...
          <Checkout monthlyPlanCode={MONTHLY.code} yearlyPlanCode={YEARLY.code}
            monthlyLabel="Subscribe — ₹399/month" yearlyLabel="Pay yearly" />
          <p style={{ fontSize: "0.85rem", color: "var(--muted)", marginBottom: 0 }}>
            {formatINR(YEARLY.amountPaise)}/year if you prefer — two months free.
          </p>
        </div>
      </div>
